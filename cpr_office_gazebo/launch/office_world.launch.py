...
def generate_launch_description():
    ...
    world_name_arg = DeclareLaunchArgument(
        'world_name',
        default_value=os.path.join(pkg_cpr_office_gazebo, 'worlds', 'office_world.world'),
        description='Path to world file'
    )

    # Process office geometry URDF
    office_geom_xacro = os.path.join(pkg_cpr_office_gazebo, 'urdf', 'office_geometry.urdf.xacro')
    office_geom_urdf = Command([
        FindExecutable(name='xacro'), ' ', office_geom_xacro
    ])
    ...
    # Spawn office world geometry
    spawn_office_geometry = ExecuteProcess(
        cmd=[
